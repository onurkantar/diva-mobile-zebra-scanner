...
@ReactModule(name = DivaMobileZebraScannerModule.NAME)
public class DivaMobileZebraScannerModule extends ReactContextBaseJavaModule implements EMDKListener, DataListener, StatusListener, ScannerConnectionListener {
  ...
  public static final String NAME = "DivaMobileZebraScanner";

  public DivaMobileZebraScannerModule(ReactApplicationContext reactContext) {
        super(reactContext);
